...
export default function BlogPostPage({ NavbarComponent, FooterComponent, post, searchQuery = '', onSearch, ExtraComponent, showPopularPosts = true, popularPostLinks = [], }) {
    return (React.createElement("div", { className: styles.post },
        ...
        React.createElement("div", { className: styles.postPage },
            React.createElement(BlogPostContent, { post: post, popularPostLinks: popularPostLinks, showPopularPosts: showPopularPosts }),
